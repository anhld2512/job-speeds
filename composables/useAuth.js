...
export const useAuth = () => {
  ...
  const login = async (username, password) => {
    try {
      ...
      const encryptedPassword = CryptoJS.AES.encrypt(password, 'jobspeedssoneteam').toString();
      ...
      const decryptedToken = CryptoJS.AES.decrypt(token, 'jobspeedssoneteam').toString(CryptoJS.enc.Utf8);

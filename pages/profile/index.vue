<template>
    <div v-if="User"  class="container max-w-6xl mx-auto">
                    ...
                    <div class="grid grid-cols-2 gap-1">
                        ...
                        <div class="information-setting">
                            <div class="grid grid-cols-1 gap-1 ">
                                <FormInPlaceEditor label="Role" :required="false" v-model="User.role"
                                    cssClass="block text-xl" :showButtonEditMode="false" :enableEditMode="false">
                                ...
                                <FormInPlaceEditor label="Created At" :required="false" v-model="User.createdAt"
                                    cssClass="block text-xl" :showButtonEditMode="false" :enableEditMode="false">
                                    <input type="text" id="Role" v-model="User.createdAt"
                                        class="input input-bordered w-full" />
                                    <template #displayValue>
                                        <span> {{ $filters.dateStringFormat(User.createdAt, "DD/MM/YYYY") }}</span>
                                    </template>
                                </FormInPlaceEditor>
                                <FormInPlaceEditor label="Updated At" :required="false" v-model="User.updatedAt"
                                    cssClass="block text-xl" :showButtonEditMode="false" :enableEditMode="false">
                                    <input type="text" id="Role" v-model="User.updatedAt"
                                        class="input input-bordered w-full" />
                                    <template #displayValue>
    ...
    <dialog ref="modalAvatar" class="modal">
        <div class="modal-box h-full w-11/12 max-w-6xl m-2 border border-2 rounded-xl shadow overflow-hidden bg-black">
            ...
            <CropperLayout class="h-full overflow-hidden" >
                <Cropper :hidden="isHiddenModal" class="cropper h-full overflow-hidden rounded-xl -mt-4" ref="cropperAvatar" :src="imgAvatar" :key="keyAvatar"

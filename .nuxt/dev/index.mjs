...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/devalue/index.js';
import destr from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/ducanhle/Desktop/JobSpeeds/job-speeds/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ducanhle/Desktop/JobSpeeds/job-speeds","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ducanhle/Desktop/JobSpeeds/job-speeds/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ducanhle/Desktop/JobSpeeds/job-speeds/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ducanhle/Desktop/JobSpeeds/job-speeds/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/ducanhle/Desktop/JobSpeeds/job-speeds/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _fNI6nwtOUB = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/ducanhle/Desktop/JobSpeeds/job-speeds";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _oDrLVORuCr = (nitroApp) => {
...
const _lazy_0kuhyC = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_0kuhyC, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_0kuhyC, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"Access-Control-Allow-Origin","content":"*"},{"name":"Access-Control-Allow-Methods","content":"GET, POST, OPTIONS"},{"name":"Access-Control-Allow-Credentials","content":"true"},{"name":"Access-Control-Allow-Headers","content":"DNT,X-Mx-ReqToken,Keep-Alive,User-Agent,X-Requested-With,If-Modified-Since,Cache-Control,Content-Type,Authorization"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"Job Speeds"};
...
const getClientManifest = () => import('file:///Users/ducanhle/Desktop/JobSpeeds/job-speeds/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
